...
final class ChildEventsObserver extends Observable<ChildEvent> {
    ...
    static final class Listener extends SimpleDisposable implements ChildEventListener {
        ...
        @Override
        public void onChildAdded(@NonNull final DataSnapshot dataSnapshot, String previousChildName) {
            if (!isDisposed()) {
        ...
        @Override
        public void onChildChanged(@NonNull final DataSnapshot dataSnapshot, String previousChildName) {
            if (!isDisposed()) {
        ...
        @Override
        public void onChildMoved(@NonNull final DataSnapshot dataSnapshot, String previousChildName) {
            if (!isDisposed()) {
