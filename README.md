...
compile 'com.androidhuman.rxfirebase:firebase-auth:11.2.0.0'
...
```groovy
compile 'com.google.firebase:firebase-auth:11.2.0'
compile 'com.androidhuman.rxfirebase:firebase-auth-kotlin:11.2.0.0'
compile 'io.reactivex:rxjava:1.2.7'
```
...
compile 'com.androidhuman.rxfirebase:firebase-database:11.2.0.0'
compile 'io.reactivex:rxjava:1.2.7'
```
...
```groovy
compile 'com.google.firebase:firebase-database:11.2.0'
compile 'com.androidhuman.rxfirebase:firebase-database-kotlin:11.2.0.0'
compile 'io.reactivex:rxjava:1.2.7'
```
