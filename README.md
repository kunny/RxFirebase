...
compile 'com.androidhuman.rxfirebase:firebase-auth:10.2.4.0'
...
```groovy
compile 'com.google.firebase:firebase-auth:10.2.4'
compile 'com.androidhuman.rxfirebase:firebase-auth-kotlin:10.2.4.0'
compile 'io.reactivex:rxjava:1.2.7'
```
...
compile 'com.androidhuman.rxfirebase:firebase-database:10.2.4.0'
compile 'io.reactivex:rxjava:1.2.7'
```
...
```groovy
compile 'com.google.firebase:firebase-database:10.2.4'
compile 'com.androidhuman.rxfirebase:firebase-database-kotlin:10.2.4.0'
compile 'io.reactivex:rxjava:1.2.7'
```
