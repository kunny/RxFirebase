...
compile 'com.androidhuman.rxfirebase2:firebase-auth:11.0.2.0'
...
```groovy
compile 'com.google.firebase:firebase-auth:11.0.2'
compile 'com.androidhuman.rxfirebase2:firebase-auth-kotlin:11.0.2.0'
compile 'io.reactivex.rxjava2:rxjava:2.0.7'
```
...
compile 'com.androidhuman.rxfirebase2:firebase-database:11.0.2.0'
compile 'io.reactivex.rxjava2:rxjava:2.0.7'
```
...
```groovy
compile 'com.google.firebase:firebase-database:11.0.2'
compile 'com.androidhuman.rxfirebase2:firebase-database-kotlin:11.0.2.0'
compile 'io.reactivex.rxjava2:rxjava:2.0.7'
```
