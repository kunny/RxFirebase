...
public final class RxFirebaseFirestore {
    ...
    @NonNull
    @CheckResult
    public static Completable setDocument(@NonNull DocumentReference ref,
    ...
    @CheckResult
    public static Completable setDocument(@NonNull DocumentReference ref,
            @NonNull Map<String, Object> value, @NonNull SetOptions setOptions) {
        return new SetMapDocumentWithSetOptionsObserver(ref, value, setOptions);
    }

    @NonNull
    @CheckResult
    public static <T> Single<DocumentReference> addDocument(@NonNull CollectionReference ref,
            @NonNull T value) {
    ...
    @NonNull
    @CheckResult
    public static Single<DocumentReference> addDocument(@NonNull CollectionReference ref,
            @NonNull Map<String, Object> value) {
    ...
    @NonNull
    @CheckResult
    public static Completable updateDocument(@NonNull DocumentReference ref,
            @NonNull Map<String, Object> value) {
