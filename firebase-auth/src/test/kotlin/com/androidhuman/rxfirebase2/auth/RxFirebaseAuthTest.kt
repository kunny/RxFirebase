...
class RxFirebaseAuthTest {
    ...
    private fun succeedAuthResultTask(userEmail: String? = null): Task<AuthResult> {
    ...
    private fun succeedProvidersResultTask(
            providerList: List<String>?): Task<ProviderQueryResult> {
    ...
    private fun succeedVoidTask(): Task<Void> {
    ...
    private fun <T> failedTask(e: Exception): Task<T> {
